...
const CommentSkeleton = () => {
  return (
    <Box className="p-2 bg-[#30363D] rounded-lg">
      <Box className="flex gap-2 p-2 items-center cursor-pointer">
        <Skeleton variant="circular" className="!bg-secondary-600 !size-11 !rounded-full" />
      ...
      <Box className="flex gap-8 p-2 justify-center">
        <Skeleton variant="rounded" className="!bg-secondary-600 w-6 !rounded-full" />
      </Box>
    </Box>
  );
};
