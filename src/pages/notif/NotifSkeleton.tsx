      ...
      {[...Array(5)].map((_, index) => (
        ...
        >
          ...
          <Box className="col-span-9 ml-4">
            ...
            <Skeleton variant="text" className="!w-28 h-5 !bg-secondary-600 mt-2" /> 
            <Skeleton variant="text" className="!w-1/2 h-5 !bg-secondary-600 mt-3" /> 
          </Box>

          <Box className="col-span-2 flex flex-col items-end">
            <Skeleton variant="text" className="!w-24 !h-3 !bg-secondary-600 mb-2" /> 
            <Skeleton variant="rectangular" className="!w-24 h-8 !bg-secondary-600 rounded-sm" /> 
          </Box>
        </Box>
      ))}
    </Box>
